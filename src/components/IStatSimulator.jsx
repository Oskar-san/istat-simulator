    ...
    <div className="p-4 space-y-4 max-w-2xl mx-auto">
      <Card>
        <CardContent className="space-y-2 p-4">
          ...
          <Button onClick={simulateResults}>Generera Blodgas</Button>
          <div className="flex space-x-2">
            <Button variant="outline" onClick={() => setScreenType("cg8")}>Visa CG8</Button>
            <Button variant="outline" onClick={() => setScreenType("cg4")}>Visa CG4</Button>
